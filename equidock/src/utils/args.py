...
parser.add_argument('-input_dir', type=str, required=True, help="Directory of input l_b and r_b .pdb files")
parser.add_argument('-output_dir', type=str, required=True, help="Directory to place the resulting .pdb file")
